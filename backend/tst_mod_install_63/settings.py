"""
Django settings for tst_mod_install_63 project.
...
ROOT_URLCONF = 'tst_mod_install_63.urls'
...
WSGI_APPLICATION = 'tst_mod_install_63.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_mod_install_63 API",
    "DESCRIPTION": "API documentation for tst_mod_install_63 App",
    "VERSION": "v1",
}
